...
<html>
<head>
<title>Belibukugue.- Keranjang Saya</title>
<!-- for-mobile-apps -->
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h2>Isi Keranjang : <span><?php echo $itungtrans3 ?> buku</span></h2>
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						?>
						<li>Total (inc. 5k Ongkir)<i> - </i> <span>Rp<?php echo number_format($subtotal) ?></span></li>
					</ul>
				</div>
